...
// A focus ring on every click makes the panels look broken; on Tab it is the
...
if (container === null) {
  throw new Error(
    'osiris.cheminfo.org cannot start: index.html has no <div id="root"></div> to mount into.',
  );
}
